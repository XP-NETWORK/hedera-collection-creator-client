...
export interface CollectionCreator extends BaseContract {
  ...
  functions: {
    ...
    checkCollection(
      collectionIdentifier: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[string]>;
  ...
  filters: {
    ...
    "newCollectionEvent(address,string,string,string,address,address,address,uint96,address)"(
      mintWith_?: null,
      name_?: null,
      symbol_?: null,
      baseURI_?: null,
