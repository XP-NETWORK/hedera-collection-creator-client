import type { BaseContract, BigNumber, BigNumberish, BytesLike, CallOverrides, ContractTransaction, Overrides, PayableOverrides, PopulatedTransaction, Signer, utils, providers } from "@hashgraph/hethers";
...
export type newCollectionEventEventFilter = TypedEventFilter<newCollectionEventEvent>;
